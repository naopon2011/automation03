...
variable "byo_nsg" {
  type        = bool
  description = "Bring your own network security group for Private Service Edge"
  default     = false
}

variable "byo_nsg_names" {
  type        = list(string)
  description = "Management Network Security Group ID for Private Service Edge association"
  default     = null
}